        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
          <div className="bg-white rounded-lg shadow-soft p-8">
            ...
            <form className="space-y-6">
              ...
              <Button variant="gold" size="lg" type="submit" isFullWidth>
                Send Message
              </Button>
            </form>
          </div>
          ...
          <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">
                      hello@polished.com<br />
                      support@polished.com
                    </p>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-lg shadow-soft p-8">
              <h2 className="font-serif text-2xl mb-6">Follow Us</h2>
              
              <p className="text-gray-600 mb-4">
                Stay updated with our latest products, tips, and promotions by following us on social media.
              </p>
